...
{
[CustomEditor(typeof(lap))]
public class lap_Editor : Editor {

	void OnInspectorGUI () {

		lap laplap = (lap)target;
	...
	//	laplap.PlayerCar = EditorGUILayout.ObjectField("",laplap.PlayerCar, player_position, true);
		GUILayout.Label("");
		GUILayout.Label("Number of laps in race:");
		laplap.numberOfLaps = (int)EditorGUILayout.FloatField("", laplap.numberOfLaps);
		GUILayout.Label("");
		GUILayout.Label("GUI text displaying lap");
//		laplap.lapDisplay = EditorGUILayout.ObjectField("",laplap.lapDisplay, GUIText, true);
	...
	//	laplap.finishedFontSize = EditorGUILayout.FloatField("", laplap.finishedFontSize);
		GUILayout.Label("");
	...
	//	laplap.useCs = EditorGUILayout.Toggle("Use C#", laplap.useCs);
	//	if (laplap.useCs == true) {
			GUILayout.Label("Drag the object here which has the");
			GUILayout.Label("c# script applied:");
	//		laplap.CsObject = EditorGUILayout.ObjectField("",laplap.CsObject, GameObject, true);
	//	}
