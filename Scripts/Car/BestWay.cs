...
{
	public class BestWay : MonoBehaviour
	{
		...
		private void DrawGizmos(bool selected)
		{
			...
			if (Waypoints.Length > 1)
			{
				...
				Gizmos.color = selected ? Color.green : new Color(1, 1, 0, 0.5f);
...
{
	#if UNITY_EDITOR
	[CustomPropertyDrawer(typeof (BestWay.WaypointList))]
	public class WaypointListDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			{
				var circuit = property.FindPropertyRelative("circuit").objectReferenceValue as BestWay;
