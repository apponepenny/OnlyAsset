...
namespace startechplus.ble.examples
{
	...
	public class BlueRx : MonoBehaviour {
		...
		private string blueRxServiceUuid = "0000FFF0-0000-1000-8000-00805F9B34FB";

		private string fastServoControlUuid = "0000FFF2-0000-1000-8000-00805F9B34FB";
			...
			while(true)
			{
				...
				if(isConnected)
				{
					...
					if (ch1IsAccel)
					{
						...
						motor[0] = 0x5a;
						motor[1] = 0xff;
						debugText.text = "this.deviceId - " + this.deviceId;
						//bleBridge.WriteCharacteristicWithIdentifiers(this.deviceId , "0000fff0-0000-1000-8000-00805f9b34fb", "0000fff1-0000-1000-8000-00805f9b34fb", motor, 8,  true, this.DidWriteCharacteristicAction);
						bleBridge.WriteCharacteristicWithIdentifiers(this.deviceId, "0000fff0-0000-1000-8000-00805f9b34fb".ToUpper(), "0000fff2-0000-1000-8000-00805f9b34fb".ToUpper(), motor, 8, false, this.DidWriteCharacteristicAction);



						//setVibratory.setvibratory_t();
						string[] temp = new string[1];
						temp[0] = "0000fff0-0000-1000-8000-00805f9b34fb";

						bleBridge.ScanForPeripheralsWithServiceUUIDs(temp, this.check);

						//setvibrates.setAction ();
						updateLog("Value: " + motor[0] + " | " + motor[1].ToString() + " | " + motor[2] + " | " + motor[3] + " | " + motor[4] + " | " + motor[5] + " | " + motor[6] + " | " + motor[7]);
