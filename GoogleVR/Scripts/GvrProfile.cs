...
public class GvrProfile {
  ...
  public enum ScreenSizes {
	...
	public static readonly Screen zenfone2 = new Screen {
		width = 0.120f,
		height = 0.068f,
		border = 0.004f
	};
  ...
  public enum ViewerTypes {
	...
	public static readonly Viewer RealFeel = new Viewer {
		lenses = {
			separation = 0.055f,
			offset = 0.0f,
			screenDistance = 0.047f,
		...
		distortion = {
			Coef = new [] { 0.10f, 0.10f },
		},
		inverse = ApproximateInverse(new [] { 0.0f, 0.0f })
	};
  ...
  public static GvrProfile GetKnownProfile(ScreenSizes screenSize, ViewerTypes deviceType) {
    ...
    switch (deviceType) {
      ...
      case ViewerTypes.GoggleTechC1Glass:
        ...
        break;
		case ViewerTypes.CardboardJun2014:
