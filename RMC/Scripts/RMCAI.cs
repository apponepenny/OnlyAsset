...
[RequireComponent (typeof(RMCRealisticMotorcycleController))]

public class RMCAI : MonoBehaviour {
			...
			private RMCRealisticMotorcycleController m_CarController;    // Reference to actual car controller we are controlling
		...
		if (m_Target == null || !m_Driving) {
			...
			if (GameStaticData.isStart) {
				...
				m_CarController.steerInput = steer;

				m_CarController.Brake = steer;




				m_CarController.motorInput = accel;
			...
			private void OnCollisionStay(Collision col)
			{
				...
				var otherAI = col.rigidbody.GetComponent<RMCAI>();
					if (otherAI != null)
					{
